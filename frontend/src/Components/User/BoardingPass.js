            ...
            <>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" display="none">
                    ...
                    <symbol id="airplane" viewBox="243.5 245.183 25 21.633">
                        <g>
                            <path fill="rgb(67, 110, 165)" d="M251.966,266.816h1.242l6.11-8.784l5.711,0.2c2.995-0.102,3.472-2.027,3.472-2.308
		...
		68,123 73,123 73,118 	"/>
            ...
            : <>{console.log("Reservation=", Reservation)}
                <Result
                    ...
                    extra={
                        <Button type="link" key="home" href="/home" style={{color:"lilac"}} >
                            Go Home</Button>
                    } /> </>
    )
}
